...
# Project-006 : Movie Seat Booking App (JS-06)
...
🔥 You don’t need to create a new template for this project, you can use [Movie_Seat_Booking_App](./index.html) template for html and css. We will be concerned in javascript side.
